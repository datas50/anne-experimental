...
public class TeleopFragment extends Fragment implements CompoundButton.OnCheckedChangeListener {
    ...
    public void onAttach(Context context) {
        ...
        studentData = scoutActivity.getData();
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (this.isVisible() && !isVisibleToUser && studentData != null) { //Leaving
        ...
        if (this.isVisible() && isVisibleToUser && studentData != null) { //Returning

            AppCompatEditText teamNumber = (AppCompatEditText) getView().findViewById(R.id.teleop_editTextTeamNumber);
            teamNumber.setText(studentData.getTeamNumber(), TextView.BufferType.NORMAL);
        }
    }
}
